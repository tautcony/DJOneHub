...
func openAPIDocument() map[string]any {
	return map[string]any{
		...
		"paths": map[string]any{
			...
			"/api/v1/network/actions/check-4g":    commandPath("4G route check", false),
			"/api/v1/network/actions/check-proxy": commandPath("proxy route check", false),
			"/api/v1/network/policy":              readPath("cellular policy"),
			"/api/v1/network/actions/policy":      commandPath("cellular policy", false),
			"/api/v1/calls":                       readPath("call monitor"),
			"/api/v1/calls/actions/reject":        commandPath("call rejection", false),
			"/api/v1/gps":                         readPath("GPS status"),
			"/api/v1/gps/actions/start":           commandPath("GPS status", false),
			"/api/v1/gps/actions/stop":            commandPath("GPS status", false),
			"/api/v1/gps/actions/refresh":         commandPath("GPS fix", false),
