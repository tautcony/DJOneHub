...
- SIM 卡信息管理：统一管理实体 SIM 与 eSIM Profile 的本地名称、号码、备注和标签，并展示设备观测到的 ICCID、IMSI 与 MSISDN
...
eSIM 页面只展示本地 SIM Profile 信息；名称、号码、备注和标签统一在“SIM 卡信息管理”中编辑。eSIM 页面中的 Profile 名称编辑仅修改 eUICC 卡内昵称。
