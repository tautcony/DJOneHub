...
func TestHeuristicLevelMapsKeywords(t *testing.T) {
	tests := []struct {
		...
		{line: "http request completed method=GET route=/api/v1/device/status workload=device_read status_class=2xx error_code= response_bytes=1195 duration_ms=3295", want: zapcore.InfoLevel},
		{line: "http request completed method=GET route=/api/v1/device/status workload=device_read status_class=4xx error_code= response_bytes=92 duration_ms=1", want: zapcore.WarnLevel},
		{line: "http request completed method=GET route=/api/v1/device/status workload=device_read status_class=4xx error_code=invalid_request response_bytes=92 duration_ms=1", want: zapcore.WarnLevel},
		{line: "http request completed method=GET route=/api/v1/device/status workload=device_read status_class=5xx error_code=internal response_bytes=92 duration_ms=1", want: zapcore.ErrorLevel},
